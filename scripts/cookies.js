    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (aux == "full") {
                ...
                document.getElementById("imagen-basket").src = '/server.wsgi/images/'.concat('carrito-less.png');
                
            } else {
                
                id.classList.add('basket-get');
                id.onclick = function(){ removeFromBasket(this, name, false) }
                id.childNodes[0].src = '/server.wsgi/images/'.concat('carrito-less.png');
            }
        }
    };
    ...
    xhttp.onreadystatechange = function() {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (aux == "full") {
                ...
                document.getElementById("imagen-basket").src = '/server.wsgi/images/'.concat('carrito-plus.png');
                
            } else if (aux == false) {
        
                id.classList.remove('basket-get');
                id.onclick = function(){ addToBasket(this, name, "") }
                id.childNodes[0].src = '/server.wsgi/images/'.concat('carrito-plus.png');
